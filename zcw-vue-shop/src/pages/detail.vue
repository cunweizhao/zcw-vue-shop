    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <p class="item-info">相机全新升级/ 960帧超慢动作 /手持超级夜景/ 全球首款双频GPS /骁龙845处理器/红<br/>外人脸解锁</p>
          <div class="delivery">小米自营</div>
          <div class="item-price">{{product.price}}元<span class="del">19999元</span></div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
          ...
          <div class="item-version clearfix">
            ...
            <div class="phone fr" :class="{'checkde':version==2}" @click="version=2">6GB+64GB 移动4G</div>
          </div>
